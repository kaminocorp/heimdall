...
<template>
  <div class="group border border-border rounded-lg p-6 bg-bg-surface hover:border-border-hover transition-colors" :class="{ 'glow-active': connection.status === 'active' }">
    <div class="flex items-start justify-between">
      ...
      <div class="flex items-center gap-3">
        <span v-if="testing" class="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full font-mono text-xs font-medium uppercase tracking-wider border border-accent/30 bg-accent/10 text-accent">
